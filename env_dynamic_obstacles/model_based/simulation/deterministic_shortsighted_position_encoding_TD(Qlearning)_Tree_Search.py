...
def run(env, num_episodes, planning_iterations, eps, lr, df):
    ...
    for i_episode in range(num_episodes):
        ...
        while True:
            ...
            # simulation based planning - TD (qlearning) tree search (using current simulation policy)
            k_trajectories = []
            ...
            for trajectory in k_trajectories:
                # unroll trajectory
...
plt.legend()
fig.savefig('./plots/deterministic_shortsighted_td(qlearning)_tree_search.png')
