# Determinstic start, shortsighted agent, position encoding based table lookup model, sample based planning with monte carlo
...
def sample_trajectory(state_transition_model, reward_model, q_table, num_actions, eps, df):
...
def run(env, num_episodes, planning_iterations, eps, lr, df):
    ...
    for i_episode in range(num_episodes):
        ...
        for k in range(planning_iterations):
            ...
            trajectory, trajectory_return = sample_trajectory(state_transition_model, reward_model, q_table, num_actions, eps, df)
