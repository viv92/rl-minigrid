# Determinstic start, shortsighted agent, position encoding based table lookup model, sample based planning with q learning
...
### function to update q_table - q learning
